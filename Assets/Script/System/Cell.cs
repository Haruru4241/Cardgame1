// Assets/Script/System/Cell.cs (이 코드로 교체하세요)

public enum CalcOp { Set, Add, Sub, Mul, Div }

public class Cell
{
    public CalcType Type { get; private set; }
    public CalcOp Operation { get; private set; }
    public object Value { get; private set; }
    public int Priority { get; private set; }

    public Cell(CalcType type, CalcOp op, object value, int priority = 3)
    {
        this.Type = type;
        this.Operation = op;
        this.Value = value;
